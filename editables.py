...
APPLICATION_ID = 1037103110369321052 #Integer - edit this to your application, giving you its name and icons
...
activity_party_size = "" # Integer - edit this to change the party size shown (2 of x)
activity_party_max_size = "" # Integer - edit this to change the party size shown (x of 4)
    #dont edit these:
activity_secrets_join = "party_secret"
activity_party_id = "party id"
